...
/**
 * The Task Manager. CLASS : Done.java PURPOSE: This class is a derivation of
 * the TaskList class. It contains all tasks that belong under the "Done" label.
 * This derived class is the most different from the other two classes that
 * share the same base class. It supports the ability to "undo" task deletions
 * by utilizing the Stack class.
 *
...
public class Done extends TaskList {
    ...
    /**
     * Method to determine if the supplied task already exists within the undo
     * stack
     *
     * @param taskName
    ...
    /**
     * Method to simulate the deletion of the supplied task with room for error
     * in case the user wishes to 'undo' their action
     *
     * @param taskName
